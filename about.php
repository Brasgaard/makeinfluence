    ...
    <div class="gridContainer">
        ...
        <section class="aboutIntro">
            <article class="aboutIntro__text">
                ...
                <p class="aboutIntro__text--paragraph">Lorem ipsum dolor sit amet, duo simul audire an. Est cu sapientem sadipscing, duis legimus eum. Me it ipsum sit amet, duo simul audire an.</p>
            </article>
        ...
        <section class="moreInformation">
            ...
            <article class="moreInformation__DYK">
                ...
                <p class="moreInformation__DYK--p">Lorem ipsum dolor sit amet, duo simul audire an. Est cu sapientem sadipscing, duis legimus eum. Me it ipsum sit amet, duo simul audire an.</p>
            </article>
            <article class="moreInformation__optimize">
                <h3 class="moreInformation__optimize--h3">Optimize your marketing</h3>
                <p class="moreInformation__optimize--p">Lorem ipsum dolor sit amet, duo simul audire an. Est cu sapientem sadipscing, duis legimus eum. Me it ipsum sit amet, duo simul audire an.</p>
            </article>
        </section>
        <section class="founders">
            <article class="founders__Kasper">
                ...
                <p class="founders__Kasper--p">Lorem ipsum dolor sit amet, duo simul audire an. Est cu sapientem sadipscing, duis legimus eum. Me it ipsum sit amet, duo simul audire an.</p>
            </article>
